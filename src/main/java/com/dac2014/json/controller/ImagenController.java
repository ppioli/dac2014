...
public class ImagenController {
    ...
    public String showImage(@PathVariable("id") Long id, 
        ...
        if (imagen != null && imagen.getRuta() != null) {
            ...
            try {
                ...
                Files.copy(FileSystems.getDefault().getPath(ruta),
                        out);
    ...
    public String create(@Valid Imagen imagen, 
        ...
        if (image != null) {
            ...
            try {
                ...
                Thumbnails.of(file)
                	.size(200, 200)
                	.toFile(rem+THUMB_SUFFIX+"."+suffix);
            } catch (Exception e) {
                e.printStackTrace();
                return "imagens/create";
            }
    ...
    public String update(@Valid Imagen imagen, BindingResult bindingResult, 
    		Model uiModel, 
    		HttpServletRequest httpServletRequest,
    		@RequestParam("image") MultipartFile multipartFile) {
        if (bindingResult.hasErrors()) {
