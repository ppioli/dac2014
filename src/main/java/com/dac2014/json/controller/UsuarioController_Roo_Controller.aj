...
import com.dac2014.json.controller.UsuarioController;
...
privileged aspect UsuarioController_Roo_Controller {
    ...
    void UsuarioController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("usuario_fechanac_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
